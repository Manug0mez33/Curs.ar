...
urlpatterns = [
    ...
    path('curso/<int:curso_id>/resena/', crear_resena, name='crear_resena'),
    path('resena/<int:resena_id>/eliminar/', eliminar_resena, name='eliminar_resena'),
]